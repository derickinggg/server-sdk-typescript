...
export interface TwilioVoicemailDetectionPlan {
     ...
     */
    voicemailDetectionTypes?: TwilioVoicemailDetectionPlan.VoicemailDetectionTypes.Item[];
    /**
...
export namespace TwilioVoicemailDetectionPlan {
    export type VoicemailDetectionTypes = VoicemailDetectionTypes.Item[];

    export namespace VoicemailDetectionTypes {
        export type Item =
            | "machine_start"
            | "human"
            | "fax"
