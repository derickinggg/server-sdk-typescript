...
export interface SipTrunkGateway {
     ...
     * @default udp
     */
    outboundProtocol?: SipTrunkGateway.OutboundProtocol;
    /**
...
export namespace SipTrunkGateway {
    /**
     * This is the protocol to use for SIP signaling outbound calls. Default is udp.
     *
     * @default udp
     */
    export type OutboundProtocol = "tls/srtp" | "tcp" | "tls" | "udp";
    export const OutboundProtocol = {
        TlsSrtp: "tls/srtp",
        Tcp: "tcp",
        Tls: "tls",
        Udp: "udp",
