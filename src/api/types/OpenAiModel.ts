...
export interface OpenAiModel {
    ...
    fallbackModels?: OpenAiModel.FallbackModels.Item[];
    /**
     ...
     */
    toolStrictCompatibilityMode?: OpenAiModel.ToolStrictCompatibilityMode;
...
export namespace OpenAiModel {
    ...
    export type FallbackModels = FallbackModels.Item[];
     ...
     * @default `strip-unsupported-validation`
     */
    export type ToolStrictCompatibilityMode =
        | "strip-parameters-with-unsupported-validation"
        | "strip-unsupported-validation";
    export const ToolStrictCompatibilityMode = {
